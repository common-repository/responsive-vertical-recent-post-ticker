...
class TickerSettingsPage
{
    ...
    $prourl = $siteurl . '/wp-content/plugins/' . basename(dirname(__FILE__))
        ?>
        <div class="wrap">
		<div style="position:absolute;float:right;left:480px;"><a href="http://beeplugins.com/product/wordpress-vertical-ticker-pro" target="_blank"><img src="<?php echo $prourl.'/assets/img/ticker-pro.png '; ?>" border="0"/></a></div>
